 ...
 * <ul>
 *   <li>{@link data.impl.ContextImpl#getName <em>Name</em>}</li>
 *   <li>{@link data.impl.ContextImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContextImpl extends MinimalEObjectImpl.Container implements Context {
	...
	public void setStatement(String newStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.CONTEXT__STATEMENT, oldStatement, statement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.CONTEXT__NAME:
				return getName();
			case DataPackage.CONTEXT__STATEMENT:
				return getStatement();
		}
