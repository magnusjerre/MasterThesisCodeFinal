...
public class DataPackageImpl extends EPackageImpl implements DataPackage {
	 ...
	 * @generated
	 */
	public EAttribute getViewComponent_Name() {
	 ...
	 * @generated
	 */
	public EReference getViewComponent_Assignments() {
		return (EReference)viewComponentEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getViewComponent_Widget() {
		return (EReference)viewComponentEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getViewComponent_ExpectedType() {
		return (EAttribute)viewComponentEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getContext_Statement() {
	 ...
	 * @generated
	 */
	public EAttribute getAssignment_Statement() {
	 ...
	 * @generated
	 */
	public EReference getAssignment_Widget() {
	 ...
	 * @generated
	 */
	public EAttribute getAssignment_UsingViewComponentNamed() {
	 ...
	 * @generated
	 */
	public EReference getAssignment_PartOfComponent() {
	 ...
	 * @generated
	 */
	public EOperation getAssignment__IsPartOfViewComponent() {
	 ...
	 * @generated
	 */
	public EOperation getAssignment__IsUsingViewComponent() {
	...
	public void createPackageContents() {
		...
		createEAttribute(viewComponentEClass, VIEW_COMPONENT__NAME);
		createEReference(viewComponentEClass, VIEW_COMPONENT__ASSIGNMENTS);
		createEReference(viewComponentEClass, VIEW_COMPONENT__WIDGET);
		createEAttribute(viewComponentEClass, VIEW_COMPONENT__EXPECTED_TYPE);
		...
		createEReference(assignmentEClass, ASSIGNMENT__WIDGET);
		createEAttribute(assignmentEClass, ASSIGNMENT__USING_VIEW_COMPONENT_NAMED);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getViewComponent_Name(), ecorePackage.getEString(), "name", null, 0, 1, ViewComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getViewComponent_Assignments(), this.getAssignment(), null, "assignments", null, 0, -1, ViewComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getViewComponent_Widget(), theModelPackage.getWidget(), null, "widget", null, 0, 1, ViewComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewComponent_ExpectedType(), ecorePackage.getEString(), "expectedType", null, 0, 1, ViewComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAssignment_Widget(), theModelPackage.getWidget(), null, "widget", null, 0, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssignment_UsingViewComponentNamed(), ecorePackage.getEString(), "usingViewComponentNamed", null, 0, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssignment_PartOfComponent(), this.getViewComponent(), null, "partOfComponent", null, 0, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
